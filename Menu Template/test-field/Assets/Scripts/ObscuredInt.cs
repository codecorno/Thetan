...
[Serializable]
public struct ObscuredInt : IFormattable, IEquatable<ObscuredInt>, IComparable<ObscuredInt>,
	IComparable<int>, IComparable
{
	...
	[SerializeField] private bool fakeValueActive;

	private static bool detector = true;
	...
	private int InternalDecrypt()
	{
		...
		if (detector && fakeValueActive && decrypted != fakeValue)
		{
